...
class DecentralizedCriticNetwork(nn.Module):
    ...
    def forward(self, n_agents, state):
        # state is [batch_size, n_agents, state_dim]
        # output is [batch_size, n_agents, 1]
...
class REINFORCE:
    ...
    def create_network(
        ...
        self.critic_network = DecentralizedCriticNetwork(
            state_features_dim,
    ...
    def compute_loss(
        ...
        actor_loss = -torch.mean(new_log_probs * returns)
    ...
    def train(self):
        ...
        for epoch in range(self.epochs):
            for rollout_data in self.rollout_buffer.get(self.batch_size):
                ...
                preprocessing_params = list(self.preprocessing_layer.parameters())
                actor_params = list(self.actor_network.parameters())
                all_params = preprocessing_params + actor_params
